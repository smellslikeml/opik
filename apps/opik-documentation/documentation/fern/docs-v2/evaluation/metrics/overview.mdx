...
| Binary Questions | Scores an output against atomic yes/no questions and returns per-question verdicts | [Binary Questions](/evaluation/metrics/binary_questions) |
